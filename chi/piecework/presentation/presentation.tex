...
% \addtobeamert emplate{frametitle}{}{%
...
{\vskip-3pt
  ...
  \begin{beamercolorbox}[wd=\paperwidth,ht=5.8ex,dp=1ex]{frametitle}%
    ...
    % \begin{figure}
    % \end{figure}
    \hspace*{4em}\small{\insertframesubtitle}
     % \hspace*{2em}

     % \includegraphics[height=10mm,width=40mm]{figures/bgheader.png}
...
\addtobeamertemplate{frametitle}{}{%
    \begin{textblock*}{100mm}(\textwidth-18mm,-12mm)
    ...
    \includegraphics[height=8mm]{figures/origami-white.png}
        % \includegraphics[height=13mm,width=50mm]{figures/bgheaderWhite.png}
    \end{textblock*}}
