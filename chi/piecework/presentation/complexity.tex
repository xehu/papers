...
\begin{frame}{What Does On--Demand Work Say?}
  \begin{columns}
    ...
    \begin{column}{0.4\textwidth}
      \only<1>{
      \includegraphics[max width=\textwidth,max height=\textheight]{figures/complexity/cw_literature/mapReduce.png}
      }
      
      \only<2>{
        \includegraphics[max width=\textwidth,max height=\textheight]{figures/complexity/cw_literature/scribe.png}
      }
      \only<3>{
