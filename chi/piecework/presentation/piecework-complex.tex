...
\only<1>{
    \begin{column}{0.66\textwidth}
      \begin{itemize}
        ...
        \scriptsize{\textcite{doi:10.2307/1883615}}\normalsize{}
        \item These measurements would be used to assign values for each specific task\\
        \scriptsize{\textcite{american1921problem}}\normalsize{}
        % \item Train engineers instituted ``The Fix'' to correct perceived unfairness\\
        % \scriptsize{\textcite{roy1954efficiency}}\normalsize{}
      \end{itemize}
    \end{column}
  }
}
  ...
  \only<2,4->{
    \only<2>{
      ...
      \begin{itemize}
        ...
        \scriptsize{\textcite{schoenberger1988fordism,tolliday1986between}}\normalsize{}
  ...
  \only<2>{
    ...
    \begin{itemize}
        ...
        \scriptsize{\textcite{taylor1914principles}}\normalsize{}
