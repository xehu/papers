...
\usepackage{booktabs,textcomp,microtype,ccicons,enumitem,moreenum,nth,cleveref,textcase}
...
\setlist{nolistsep}
\def\plaintitle{Referral HITS: Compensating Crowd Workers for Facilitating Work}
