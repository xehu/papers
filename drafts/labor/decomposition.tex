...
The fourth and final stage was narrow expertise training. As World War II raged and there was a dearth of skilled workers, managers trained women just enough to be able to complete their tasks~\cite{hart2013rise}. Over time, these women could gain proficiency and gain broader expertise.
...
Second, we began to modularize and measure existing expertise (e.g., software engineering, design) so that it could be brought into crowdsourcing systems~\cite{foundry,Chen2016}.
...
The fourth stage, then, appears likely to occur: narrow training of workers for expert tasks. 
