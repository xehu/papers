...
the historical piecework and the contemporary crowdwork \msb{consistency: crowdwork or crowd work?}
...
,         considering in particular
        the factors that may have led to piecework's \msb{(and crowd work's?)} eventual demise
\end{inlinelist}.
...
, in \citeyear{hughRaynbirdTaskWork}, also proves to be the most circumspect in its wording.} \msb{The circumspect bit is weird, not sure how to interpret that.}
...
\cite{rowan1901premium}. \msb{That point runs way too fast for me --- why does it muddy the waters? Either simplify, cut, or slow it down.}
Nevertheless,
this work offers us an intuition for what piecework is, if not a bright--line rule. \msb{I'd cut that, I think it's fine...}
...
independence and some sense of locus \msb{not sure what that means...a sense of place?}
...
\end{inlinelist}
\cite{hart2013rise}. \msb{explain that in your own words now --- that the piecework infrastructure allows lower-skilled people to be used for skilled positions, by building the expertise into the workflow}
...
\cite{grier2013computers}. \msb{year?}
...
, each time finding additional ways to leverage the advantages of piecework.} \msb{that sentence has some circular logic going on, it took a path to leveraging the advantages of itself?}
...
, describing piecework comprehensively \msb{here's an example of why I'm confused. there's guidance and comprehensive description, but this text doesn't tell me what actually happened with piecework.}
...
\cite{Brown01041990}. \msb{Seems weird to leave the question hanging. Either un-questionify it, or answer it.}
