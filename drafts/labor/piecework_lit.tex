...
\topic{\citeauthor{hart2013rise} offer another series of compelling insights toward
...
\subsection{A Primer of Piecework}\label{sec:pieceworkPrimer} % yay rhyming?
\topic{In this section we will offer a brief overview of the history of piecework;
this should not be mistaken for a comprehensive or especially rigorous background.}
...
\topic{Fordism and scientific management thrust piecework into higher gear, especially as
