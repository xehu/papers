...
\end{inlinelist}
\msb{missing ending punctuation}
...
offering examples:
\msb{the spacing is not even on the two sides of the ~[\dots]~ in the PDF}
...
\msb{more uneven spacing in the quotes. will stop pointing it out here, please fix throughout}
