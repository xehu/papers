...
% \note{\citeauthor{quinnbedersonTaxonomy} offer a taxonomy of crowd work,
% but at a high level my takeaway consists of the following dimensions:
% This is work involving\dots
% \begin{itemize}
% \item some sort of \textbf{motivation}
% \item some sort of \textbf{quality control}
% \item some approach to \textbf{work aggregation} % this is actually kind of useful, but the wrong framing
% \item some amount of \textbf{human skill}
% \item some \textbf{process order involving a requester, a worker, and maybe a computer at various points}
% \item some notion of \textbf{task/request ``cardinality''}
% \end{itemize}
% The authors get into the dimensions that these features can take on,
% but it nevertheless seems so vague that almost any form of  work can be plotted on this 6--dimensional graph.
% }
