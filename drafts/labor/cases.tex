...
\subsubsection{Achieving complexity}\label{sec:decomposition}
...
``flash teams'' to accomplish work typically thought of as only within reach of experts
\cite{foundry}.
...
The work described thus far has explored along myriad paths the ways that
we can manage workers for the purpose of accomplishing complex tasks with
rapidly sourced workers from all over the world.
Critically, the work's defining characteristic involves
the use of the Internet as a medium both 
to coordinate workers, as well as to do the work itself.
...
---
\citeauthor{professionalCrowdworkEthics} in particular foresaw this danger
and warned of it in, but they were by no means alone in their warnings
...
Research into piecework has considered the decomposition of work;
\citeauthor{10.2307/23702539} describes piecework in \citeyear{10.2307/23702539} as
