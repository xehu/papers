...
\ali{Types of things that people are trying to do that are complex: e.g. 1, e.g. 2, etc\dots}
...
% \topic{Research into piecework has also explored the limits of piecework,
% with some findings.}
...
% the language used to describe the factors considered for piecework to thrive.}
First, we look to
