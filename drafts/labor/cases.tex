...
As we'll discuss through these dimensions,
exploring the extents to which work can be
decomposed,
contextually abstracted, and
made more resilient to attrition,
...
%                                |_|                                  
% lol i can't believe this worked i'm going to do this with every section.
...
Piecework Piecework Piecework Piecework Piecework Piecework Piecework 
