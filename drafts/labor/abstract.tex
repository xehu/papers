...
To do so, we identify the mechanisms that enabled and limited piecework historically, and
identify whether crowd work faces the same pitfalls or might differentiate itself.
This approach introduces theoretical grounding that can help address
challenging, persistent questions in crowd work,
and suggests design interventions that may help
