...
\begin{table*}[t]
  ...
  \begin{tabularx}{\textwidth}{l X X X}
    ...
    \small{ % Piecework was limited by technology; on--demand work is enabled by it. 
...
%In particular, the predictions that have emerged in the literature surrounding the future of crowd work have run the spectrum
...
\msb{Shouldn't we bring up the discussion from the rebuttal about history/future connections here?}
