...
% with a set of tools and perspectives that took shape only after piecework's nascent years.
...
whether given socio--technical infrastructures % like Mechanical Turk (AMT)
