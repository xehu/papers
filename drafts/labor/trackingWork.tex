...
\usepackage{todonotes,txfonts,balance,graphics,color,alphalph,subfiles,appendix}
...
% \usepackage{biblatex}
% \usepackage[square,numbers]{jnatbib}
...
\newcommand{\notinsubfile}[1]{}
\newcommand{\note}[1]{\footnote{#1}}
\newcommand{\topic}[1]{\textbf{#1}} % if you're in a subfile, bold the \topic sentences
\newcommand{\joke}[1]{#1} % if you're in a subfile, bold the \topic sentences

\begin{document}
\renewcommand{\topic}[1]{#1} % don't do anything with \topic sentences; this is just for drafting 
\renewcommand{\joke}[1]{} % don't do anything with \jokes! Just throw them away!
