...
\newcommand{\notinsubfile}[1]{}
\newcommand{\note}[1]{\footnote{#1}}
\newcommand{\topic}[1]{#1} % don't do anything with \topic sentences; this is just for drafting 
\onlyinsubfile{\renewcommand{\topic}[1]{\textbf{#1}}} % if you're in a subfile, bold the \topic sentences
