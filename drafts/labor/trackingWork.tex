...
\newcommand{\crowdworkpers}{Crowdwork's perspective.}
\newcommand{\whatchanged}{What's different about crowdwork.}
\newcommand{\implication}{Implications for crowdwork research.}
\newcommand{\pieceworkdefinition}{piecework is the paradigm of renumeration that is largely made compelling for its use of ``payment for results''%
