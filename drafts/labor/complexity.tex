...
\topic{\citeauthor{crowdForgeKittur} were among the first to ask
whether crowdsourcing could be used for more than parallelizing tasks~\cite{crowdForgeKittur}.}
