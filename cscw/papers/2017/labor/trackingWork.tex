...
% \citeauthor{horowitz2010anatomy} found that optimally directing questions to relevant answerers
% on various domains could yield relevant answers at enormous scales
% \cite{horowitz2010anatomy}.
...
% (we will, however, discuss the implications of these findings in further depth later)
\cite{cheng2015break}.
...
% This work on decomposition is not strictly new;
...
% \msb{netflix prize?}
% that's an interesting example in the same vein as what i'm thinking about, but this is a whole business of it
% \textbf{INNOCENTIVE} oh my gosh it just clicked my life is complete right now at 9:54am.
% I don't even need to submit anymore.
% I'm satisfied having pulled this strand of a memory out of my brain.
