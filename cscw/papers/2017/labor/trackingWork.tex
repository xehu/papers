...
\begin{abstract}
  With growing attention in on--demand labor
  ...
  predicts and indeed precipitates both the contributions
  that have been made toward the development of on--demand labor and crowd work
  as well as the fallout among workers and researchers with regard to the disillusionment and alienation of work.
  ...
  % in various on--demand industries,
  we turn our lens to look to the future,
...
This topic can be condensed into three major areas:
\begin{inlinelist}
...
\cite{riisOtherSideLives}.
\citeauthor{riisOtherSideLives}'s photodocumentary of pieceworkers has even been re--examined among Turkers
\cite{facesOfMechanicalTurk}.
We argue that these investigations naturally follow the flourishing and fallout of what is,
fundamentally, piecework mediated in new ways.
...
It shouldn't surprise us, then, that workers have resisted the management imposed on them both by people and by systems,
often without recourse or room for feedback.
