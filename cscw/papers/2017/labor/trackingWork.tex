...
% % \msb{this seems speculative---I'm not sure whether they knew what was coming. and wasn't income distribution different then? Who was the `they' in this case? Industrialists?}
...
--- and the features inherent to it (such as decomposition of tasks) --- % and others?
precipitated the negative outcomes that historically led workers to collective organization and action in the early \nth{20} century;
that aspects of piecework like 
% Indeed, the model of work distribution and management we know as piecework
% --- including the methods and work--flows that facilitate this kind of work ---
% ultimately cause what we recognize broadly as
% frustration,
% alienation, and
% resistance
% among gig workers.
